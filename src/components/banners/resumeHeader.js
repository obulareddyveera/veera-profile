            ...
            <div className='flex flex-col items-center justify-center mt-4 border-b-2 border-b-white'>
                <div className="avatar online">
                    <div className="w-24 rounded-full">
                        <Image width={"100%"} height={"100%"} src="/images/profile.jpeg" alt="Veera Reddy" />
                    </div>
                </div>
                <div className='w-full border-t-2 border-t-white pt-2'></div>
                <div className='flex justify-center items-center m-2'>
                    <Link href="https://www.cakeresume.com/s--8MD7uD0_FMzCKjO3h-nygQ--/veera-obulareddy" target="_blank">
                ...
                <div className='grid grid-rows-2 grid-cols-2 gap-2'>
                    <Link href="https://medium.com/@obulareddyveera" target="_blank">
                    ...
                    <Link href="https://github.com/obulareddyveera" target="_blank">
                        <div className="btn btn-sm btn-secondary">
                            <FontAwesomeIcon icon={faGithub} className="w-3 h-3 m-1" />
                            <span className='m-1'>Github</span>
                        </div>
                    </Link>
                    <Link href="https://www.linkedin.com/in/veera-obulareddy-5955561a1/" target="_blank">
                        <div className="btn btn-sm btn-info text-white">
